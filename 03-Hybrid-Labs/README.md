...
| 04 | **On-Prem Exchange to Exchange Online Migration** | Deploy Exchange Server on Azure, configure SPF/DKIM/DMARC, and migrate mailboxes to Exchange Online in Azure. |
| 05 | **SAN Backup to Azure** | Integrate SAN backups with Azure Blob Storage for cloud disaster recovery. |
